...
import AutoroleButtonManager from "./manager/AutoRoleButtonManager";
...
class SuwaClient extends Client {
  ...
  public autoRoleManager: AutoroleButtonManager;
  ...
  constructor(clientId: string) {
    ...
    this.autoRoleManager = new AutoroleButtonManager(this);
  }
